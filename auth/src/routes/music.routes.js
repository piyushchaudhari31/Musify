...
const { createPlaylist, getAllMusic, getArtistMusics, getMusicByid, getPlaylist, getPlaylistbyArtist, getPlaylistByid, MusicController, getAllPlaylist, getArtistDetail, getArtistMusicbyId } = require('../controllers/music.controller.js');
...
router.get('/artist',authUserMiddleware,getArtistDetail)

router.get('/artist/:id',authUserMiddleware,getArtistMusicbyId)
